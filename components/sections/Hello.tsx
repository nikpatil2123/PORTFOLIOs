export default function Hello() {
  return (
    <div className="p-8 bg-[#011627] min-h-full">
      <div className="max-w-4xl mx-auto">
        <div className="text-gray-400 mb-2">Hi all. I am</div>
        <h1 className="text-5xl font-mono text-white mb-4">Nikhil Patil</h1>
        <div className="text-[#4fd1c5] text-xl mb-8">{`> Front-end developer`}</div>
        ...
        <div className="space-y-4 font-mono">
          <div>
            ...
            <div>
              <span className="text-[#C792EA]">const</span> <span className="text-[#82AAFF]">telephoneNum</span> ={" "}
				<a href="tel:+917096589655" className="text-[#C3E88D]">"+91 7096589655"</a>;
          ...
          <div>
            ...
            <div>
              ...
              <span className="text-[#C3E88D]"><a href="https://github.com/nikpatil2123">"https://github.com/nikpatil2123"</a></span>;
            </div>
          </div>
		  <div>
            ...
            <div>
              <span className="text-[#C792EA]">const</span> <span className="text-[#82AAFF]">githubLink</span> ={" "}
              <span className="text-[#C3E88D]"><a href="https://www.linkedin.com/in/idknik2123/">"https://www.linkedin.com/in/idknik2123/"</a></span>;
            </div>
          </div>
        </div>
      </div>
